...
MARKET_STRUCTURE_CONFIG = {
    ...
    "minimum_breakout_distance_percent":
    ...
    "require_break_of_structure_confirmation":
    ...
    "enable_adaptive_structure_thresholds":
